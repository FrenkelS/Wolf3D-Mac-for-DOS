...
ia16-elf-gcc -c i_vmy.c     $RENDER_OPTIONS -march=$CPU -mcmodel=small -mnewlib-nano-stdio -mregparmcall -O1 -fomit-frame-pointer -flto -fwhole-program
...
export GLOBOBJS+=" i_vmy.o"
export GLOBOBJS+=" i_vmya.o"
